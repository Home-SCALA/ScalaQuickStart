...
========================
Related post is **(** [Learning Scala](http://tirthalpatel.blogspot.com/2015/06/steps-to-create-scala-eclipse-project.html) **|** [Project - Learning Scala](https://github.com/tirthalpatel/Learning-Scala) **|** [REST Test](http://www.slideshare.net/IainHull/rest-test) **)**
...
> * Sbt 0.13.9 - a build tool for Scala (http://www.scala-sbt.org/download.html)
> * Scala IDE for IntelliJIDEA
